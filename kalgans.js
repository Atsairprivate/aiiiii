...
🌷 KALAU MAU RENAME TARO CREDITS GUA : ☆Ⱥէʂąìɾ⏧☆ */
...
browser: ['Atsair Suka Janda','Safari','1.0.0'],
auth: state})
//=================================================//
...
let buttons = [
{buttonId: `☆Ⱥէʂąìɾ⏧☆`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
